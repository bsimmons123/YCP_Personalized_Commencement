...
<html lang="en-US">
	...
	<div id="instructions">
				...
				<div id="buttons" style="margin-left:0%; padding:0px; display: inline;">
					<input class="btn btn-secondary" style="width: 20%; margin-right: 51.2%;" type="button" onclick="window.location='http://localhost:8081/pcomm/_view/edit_student_content.jsp'" value="Edit Content">
