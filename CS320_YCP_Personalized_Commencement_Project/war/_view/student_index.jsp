...
<html lang="en-US">
	...
	<div id="instructions">
				...
				<div id="buttons" style="margin-left:0%; padding:0px; display: inline;">
					<input class="btn btn-secondary" style="width: 20%; margin-right: 51.2%;" type="button" onclick="window.location='${pageContext.request.contextPath}/_view/edit_student_content.jsp'" value="Edit Content">
					<input class="btn btn-success" style="width: 28%; margin-left:0%;" type="button" onclick="window.location='${pageContext.request.contextPath}/_view/graduation_preview.jsp'" value="Preview Content">
				</div>
			</div>
